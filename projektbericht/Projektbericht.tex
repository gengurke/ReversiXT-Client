...
\newpage
   ...
   Es ist wichtiger mehr Zugmöglichkeiten als der Gegnerische Spieler zu haben. Ein Beispiel hierzu ist Abbildung \ref{fig:3.2.3}, denn obwohl der rote Spieler mehr Steine hat wird der blaue Spieler in den nächsten Zügen Rot überholen, da er deutlich mehr Zugmöglichkeiten hat.
    ...
    %TODO kurze Beschreibung Unterschied Paranoid und Alpha-Beta
	...
	Die Ergebnisse des Projekts können sich auch sehen lassen. Die KI wird nicht mehr disqualifiziert und erreicht gute Punktewerte. In der Zeit, nach Abgabe dieses Berichts wollen wir noch ein paar Verbesserungen in unserem Clienten durchführen. In der Heuristik soll eine kreis- und wellenförmige statische Bewertung um Choise-, Bonussteine und Ecken implementiert werden. Wir erhoffen uns dadurch mehr, essenzielle Überschreibsteine und eine bessere Kontrolle der Karte zu erhalten. Außerdem wollen wir noch an verschiedenen Stellen mehr Leistung, also höhere Tiefe, aus der KI raus holen.\\
