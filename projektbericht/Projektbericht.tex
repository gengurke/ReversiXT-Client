...
%TODO Reversi und ReversiXt gegenüberstellen (mit 2 bildern)
%TODO Spielelemente erklären
Wie anfangs schon erwähnt, hat die Standartversion von Reversi ein relativ kleines Spielfeld und nur zwei Spieler. Es gibt nur zwei Arten von Spielsteinen, nämlich die der zwei Spieler. Das steht im starken Kontrast zu ReversiXT, für das dieses Projekt eine KI entwickelt. In der erweiterten Version des Spiels sind bis zu acht Spieler erlaubt. Außerdem gibt einige Sonder-Spielsteine und Felder. Die Sonderspielsteine bestehen aus "Überschreibsteinen", die es ermöglichen gegnerische Spielsteine umzufärben und "Bomben" mit denen man in der zweiten Phase des Spiels Bereiche des Spielbretts zerstören kann. Dazu folgt später mehr. Die neuen Spielfelder sind "Wahlfeld" (choice)(c), welches es dem besetzenden Spieler ermöglicht, mit einem Mitspieler seiner Wahl Spielsteine zu tauschen (auch mit sich selbst). "Inversionsfelder"(inversion)(i), wenn aktiviert, verschieben die Spielerfarben um eins. Besetzt ein Spieler ein "Bonusfeld"(bonus)(b) so hat er die Möglichkeit eine extra Bombe oder einen extra Überschreibstein zu erhalten. Zuletzt gibt es noch "Expansionsfelder"(expansion)(x). Diese agieren wie "tote" Spieler und können durch normale Züge oder das Platzieren von Überschreibsteinen eingefärbt werden.
...
%TODO Einleitung für diesen Teil
...
%TODO schauen wann in korretur pdf steht

%TODO Foldgender Teil anpassen dass es in diese section passt (Kopiert aus der einleitung)
...
%TODO Alle genauer erklären für was bestimmte Vrkenntnisse im Projekt wichtig sind
...
%TODO - Zukünftige Tools einbauen wie maven, junit,ant... jenachdem was wir benutzen.
...
%TO DO geeignete Datenstruktur für Transitionen nachtragen  
